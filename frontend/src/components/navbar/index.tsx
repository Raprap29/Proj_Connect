...
const Navbar = () => {
    ...
    return (
        <>
            <aside id="default-sidebar" className="fixed top-0 border-1 border-gray-300 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">

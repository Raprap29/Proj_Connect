...
export default function Login() {
    ...
    return (
        <div className='bg-[#003366] flex justify-center items-center h-[100vh] w-full'>
            <form className="max-w-md mx-auto bg-white w-full p-5 rounded-lg">
                <h1 className='font-medium text-center text-3xl mb-2'>LOGIN</h1>
                <div className="relative z-0 w-full mb-5 group">
                    <input type="email" onChange={handleChange} name="username" id="floating_username" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div className='w-full mt-5'>
                    <button type="submit" className="text-white w-full bg-green-700 py-3 rounded-lg font-medium">Login</button>
                </div>
